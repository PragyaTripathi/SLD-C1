...
def sytheticDATA(size): 
	...
	# plt.plot(data1_x, data1_y,'o',label="Main Data")
	# add white noise
	mean_whitenoise = [0, 0]
	...
	# plt.plot(data2_x, data2_y,'+',label="White Noise")
	...
	# plt.plot(data2_x, data2_y,'.',label="Noise")
...
# # # print x.shape
# # sigma = 1/(2**0.5)
# graphFactory = GraphFactory(x, sigma, 0, '/home/ldapuser1/code-from-git/SLD-C1/SyntheticDataTest/', True)
# graphFactory.createGraph()
# graphFactory2 = GraphFactory(y, sigma, 0, '/home/ldapuser1/code-from-git/SLD-C1/SyntheticDataWithAnomaliesTest/', True)
