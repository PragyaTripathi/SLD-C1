...
sig = 1/(2**0.5)
# graphFactory = GraphFactory(ndarray1, sig, 4, '/Users/Pragya/Documents/SDL/SLD-C1/January1994/', False)
# graphFactory.createGraph()
graphFactory2 = GraphFactory(ndarray2, sig, 4, '/Users/Pragya/Documents/SDL/SLD-C1/January1995/', False)
